...
class MNTOBF:
    ...
    def encrypt1(self):
        ...
        init = ";".join(init)
        self.code = f'''
# Obfuscated using https://github.com/MNT-W/MNTOBF
...
'''.strip().encode()
    ...
    def encrypt2(self):
        ...
        self.code = f'''# Obfuscated using https://github.com/MNT-W/MNTOBF
